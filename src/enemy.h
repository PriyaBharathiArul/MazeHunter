/**
 * @file enemy.h
 * @brief The file contains the declaration for the enemyclass and its methods.
 * The enemy class is a subclass of the Agent class and is used to create an enemy that chases the player 
 * and shoots at the player when the player is within a given range.
 *
...
class enemyController : public Process, public AgentInterface {
    ...
    * It handles the shooting of the enemy when the player is within range.
    * It handles the chasing of the player by the enemy when the player is within range.
